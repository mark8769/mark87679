...
- 🌱 Currently using (**React, Spring Boot, Flask, AWS Services**). Excited to learn more about Cybersecurity through CS50 Cybersecurity [Course Link](https://cs50.harvard.edu/cybersecurity/2023/) and currently working towards [Google Cybersecurity cert](https://www.coursera.org/professional-certificates/google-cybersecurity). Also AWS Certified Cloud Practioner certified working towards my next cert [Solutions Architect](https://aws.amazon.com/certification/certified-solutions-architect-associate/)
